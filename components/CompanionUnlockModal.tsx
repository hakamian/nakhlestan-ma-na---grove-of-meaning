...
const CompanionUnlockModal: React.FC<CompanionUnlockModalProps> = ({ isOpen, onClose, onUnlock }) => {
    ...
    >
      ...
      >
        ...
        <h2 className="text-2xl font-bold mb-2 text-yellow-300">
            فعال‌سازی «همراه معنا»
        </h2>
        {user && user.companionTrialSecondsUsed > 0 && (
            <p className="text-sm bg-red-900/50 text-red-300 py-1 px-3 rounded-md mb-4">
                دوره آزمایشی شما به پایان رسیده است.
            </p>
        )}
        <p className="text-gray-300 mb-6">
            با مربی هوشمانا خود به صورت **صوتی و بی‌درنگ** گفتگو کنید. این یک همسفر همیشه حاضر برای کاوش در دنیای درون و یافتن شفافیت در مسیر زندگی شماست.
        </p>

        <div className="bg-gray-700/50 rounded-lg p-4 text-center mb-6 border border-gray-600">
            <h3 className="font-semibold text-lg">با کاشت «نخل آگاهی» این قابلیت را فعال کنید</h3>
...
export default CompanionUnlockModal;